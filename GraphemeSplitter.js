/*
I HAVE NOT WRITTEN THIS SCRIPT
The script belongs to: https://github.com/orling/grapheme-splitter
I have merely modified it to be able to import it in Scriptable. 
...
exports.splitGraphemes = function(str){
    var res = [];
    var index = 0;
    var brk;
...
exports.iterateGraphemes = function(str) {
    var index = 0;
    var res = {
        next: (function() {
            var value;
            var brk;
            if ((brk = exports.nextBreak(str, index)) < str.length) {
...
exports.countGraphemes = function(str){
    var count = 0;
    var index = 0;
    var brk;
    while((brk = exports.nextBreak(str, index)) < str.length){
